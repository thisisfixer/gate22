...
import { type App } from "@/features/apps/types/app.types";
...
import { useAppLinkedAccounts } from "@/features/linked-accounts/hooks/use-linked-account";
          ...
          <TooltipProvider>
            <div className="flex justify-end  items-end  flex-wrap gap-2  ">
              <Tooltip>
                ...
                <TooltipContent>
                  <p className="text-xs">
                    {`Functions in This App: ${app.functions?.length || 0}`}
                  </p>
                </TooltipContent>
              </Tooltip>
              <Tooltip>
